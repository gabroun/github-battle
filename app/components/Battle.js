  ...
  render() {
    ...
    return (
      <div>
        ...
        {playerOneImage && playerTwoImage && <Link className="button battle" to={{pathname: match.url + '/results', search: `?playerOneName=` + playerOneName + `&playerTwoName=` + playerTwoName  }}>Battle</Link>}
      </div>
    );
  }
}
